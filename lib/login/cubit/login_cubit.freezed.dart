...
mixin _$LoginState {
  ...
  LoginAction get action => throw _privateConstructorUsedError;
...
class _$_LoginState implements _LoginState {
  ...
  @override
  String toString() {
    return 'LoginState(user: $user, token: $token, message: $message, action: $action, status: $status)';
  }
...
abstract class _LoginState implements LoginState {
  const factory _LoginState(
      ...
      final String message,
      final LoginAction action,
      final LoginStatus status}) = _$_LoginState;
